...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public cards: ChristmasCard[] = [
    ...
    { id: 5, theme: 'reindeer', color: 'linear-gradient(135deg, #8e44ad 0%, #5e3370 100%)', icon: '🦌', title: 'Reindeer Blessing', message: 'Chúc bạn một mùa lễ tràn đầy tiếng cười và niềm vui.', decorations: ['✨', '❄️', '🦌', '🎀'] },
    ...
    { id: 9, theme: 'bell', color: 'linear-gradient(135deg, #f1c40f 0%, #f39c12 100%)', icon: '🔔', title: 'Jingle Bells!', message: 'Tiếng chuông vang lên báo hiệu một mùa lễ ngập tràn hạnh phúc.', decorations: ['🔔', '✨', '🎶', '🎄'] },
    ...
    { id: 11, theme: 'candycane', color: 'linear-gradient(135deg, #ff4e50 0%, #f9d423 100%)', icon: '🍭', title: 'Sweet Wishes', message: 'Chúc bạn có thật nhiều khoảnh khắc ngọt ngào bên người thương.', decorations: ['🍭', '🎀', '✨', '🎄'] },
    ...
    { id: 15, theme: 'bear', color: 'linear-gradient(135deg, #a8e6cf 0%, #3dccc7 100%)', icon: '🐻‍❄️', title: 'Polar Hugs', message: 'Gửi đến bạn một cái ôm ấm áp như chú gấu Bắc Cực giữa mùa đông lạnh giá.', decorations: ['❄️', '🐻‍❄️', '🧊', '✨'] },
  ...
  generateCalendarData() {
    ...
    this.emptySlots = []; const now = new Date(); const cm = now.getMonth() + 1; const cd = now.getDate();
    for (let i = 1; i <= 31; i++) {
      let d = items[(i - 1) % items.length], r = d.r as any;
      if (i === 24) { d = { t: "Đêm Thánh", i: "🌙", m: "Đêm nay...", r: 'legendary' }; r = 'legendary'; }
      if (i === 25) { d = { t: "MERRY CHRISTMAS!", i: "🎅", m: "Giáng sinh an lành...", r: 'legendary' }; r = 'legendary'; }
